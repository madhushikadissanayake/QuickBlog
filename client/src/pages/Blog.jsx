  ...
  return data ? (
    <div className='relative'>
     ...
     <div className='text-center mt-20 text-gray-600'>
      ...
      border-primary/35 bg-primary/5 font-medium text-primary'>Michel Brown</p>
     </div>
         ...
         <div className='flex flex-col gap-4'>
          ...
          <div className='max-w-3xl mx-auto'>
            ...
            max-w-lg'>
              ...
              <textarea onChange={(e)=> setContent(e.target.value)} value={content} placeholder='Comment' className='w-full p-2 
              border border-gray-300 rounded outline-none h-40' required></textarea>
