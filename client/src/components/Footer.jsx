  ...
  return (
    ...
    <div>
      ...
      <p className='max-w-[410px] mt-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
        Illo inventore possimus quod, earum recusandae similique quis culpa nostrum velit, voluptate 
        voluptatum ipsa enim vel eum error itaque, quam dolore voluptatibus.</p>
    </div>
